...
//////////////////////////
    ...
    <body style="background: #112d5c;opacity: 0;">        
                    
                    <div id="slide2o3" class="text-center" style="position: absolute;left: 150px;top: 250px;">
                        <span class="texto-cabecera" style="color: white;line-height: 70px;text-shadow: 0 0 0 white;font-size: 35pt;"><i>"El conocimiento del mercado</i></span>
                    </div>
                    
                    <div id="slide2o4" class="text-center" style="position: absolute;left: 170px;top: 310px;">
                        <span class="texto-cabecera" style="color: white;line-height: 70px;text-shadow: 0 0px 0px white;font-size: 35pt;"><i>siempre nos invita a nuevas <span style="font-size: 40pt;">oportunidades</span>"</i></span>
                        <!--<hr>-->
                    </div>
                                        
                    <img id="slide2o1" style="position: relative;left: 840px;top: 440px;width: 280px;" src="<?php echo URL;?>/Recursos/img/LogoALTv2.png">
