...
setTimeout(function () {
    $('#slide2o1').removeClass('animated fadeOut');
    $('#slide2o1').addClass('animated fadeIn');     
    $('#slide2o1').css('filter','blur(0px)');
},6500);
...
//////////////////////////
    ...
    <body style="background: #faa51a;opacity: 0;">
        ...
        <img class="img-responsive" id="slide2o1" style="position: absolute;filter: blur(2px);width: 850px;left: 12%;top:15%;" src="<?php echo URL;?>/Recursos/img/mensaje2V3.png">
        
        <img id="slide2o2" class="LupaOff" src="<?php echo URL;?>/Recursos/img/lupaconluna.png">
                       
                                        
                    
<span id="slide2o3" class="texto-cabecera" style="color: white;position: absolute;left: 830px;top: 480px;width: 400px;font-size: 25pt;text-align: center"><i>"La información es más clara si la vemos como oportunidades"</i></span>
    </body>
</html>
