...
<html>
	...
	<?php require_once "plantillas/cabecera-estilo.html"; ?>
        ...
        <!--Escript de vista-->
        <script type="text/javascript" src="<?php echo URL;?>/Views/script/ranking-ventas-por-vendedor.js"></script>       
		...
		function PrintDiv(id) {
            ...
            myWindow.document.write('<html><head><title>Ranking de ventas por vendedores - VENTAS</title>');
		...
		<div class="container" style="margin: 160px auto 0px; max-width: 90%;font-family: Nunito;">
			...
			<div class="row">
				<div class="col-lg-12 text-right"> 
					<h4>MÓDULO DE VENTAS Y PEDIDOS <span class="glyphicon glyphicon-triangle-right" style="font-size: 13pt;"></span>RANKING DE VENTAS POR VENDEDOR</h4>
					<hr>
				</div>	
				...
				<div class="col-lg-12" style="margin: 25px auto 0px; max-width: 100%;">
					...
					<div class="row">
						...
						<div class="col-lg-4" style="padding-top: 25px;padding-right: 40px;">
							<div class="form-group">
								<button id="btnConsultar" type="submit" class="btn btn-default" style="width: 100%;background-color: #efefef;"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> CONSULTAR VENDEDORES</button>
							</div>							
					...
					<div class="row" style="background-color: #777777;padding: 8px;">
						...
						<div id="VistaPedido" class="col-xs-12" style="padding-top: 5px;padding-left: 40px;background: white;">	
								...
								<table style="width: 100%;font-size: 9.0pt;">
									<tr>
										<td class="text-center" style="padding-top: 40px;">
											<u>RANKING DE VENTAS POR VENDEDOR <label id="fechai"></label> AL <label id="fechaf"></label><br>SHANDONG TIANXIN TRADING COMPANY S.A.C.</u>
										</td>
									</tr>
								...
								<table style="width: 100%;font-size: 9.0pt;">
									<tr><td style="width: 10px;">POSICIÓN</td><td style="width: 50px;">DNI</td><td style="width: 200px;">NOMBRES Y AELLIDOS</td><td style="width: 100px;">TIENDA</td><td style="width: 150px;">MONTO EN VENTAS</td></tr>
