 ...
 $(document).ready(function () {
    ...
    $("#BtnExport2").click(function(){ 
        ...
        var Fechafin=$("#FechaFin").val();        
         ...
         win=window.open("./Reportes/ExcelReporteDeVentasCostos.php?FechaInicio=" + Fechaini + "&FechaFin="+ Fechafin + "&idTienda="+ idTienda , "_blank", "menubar=yes, scrollbars=yes, resizable=yes, top=300, left=500, width=400, height=20","false");                        
