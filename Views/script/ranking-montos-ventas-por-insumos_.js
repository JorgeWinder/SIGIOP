 ...
 $(document).ready(function () {
    ...
    $("#BtnExport").click(function(){ 
        ...
        var Fechafin=$("#FechaFin").val();        
         ...
         win=window.open("./Reportes/ExcelRankingMontosVentasPorInsumos.php?FechaInicio=" + Fechaini +"&FechaFin="+ Fechafin , "_blank", "menubar=yes, scrollbars=yes, resizable=yes, top=300, left=500, width=400, height=20","false");                        
