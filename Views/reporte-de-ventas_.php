				...
				<input type="hidden" id="idtienda" value="<?php echo $_SESSION['idTienda'];?>">
					...
					<div class="row">
						...
						<div class="col-lg-3" style="padding-top: 0px;padding-right: 40px;">
							...
							<div class="form-group">
								<button id="BtnExport" type="submit" class="btn btn-default" style="width: 100%;" onclick=""><span class="glyphicon glyphicon-save" aria-hidden="true"></span> EXPORTAR REPORTE</button>
							</div>
