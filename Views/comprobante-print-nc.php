  ...
  function CalValTotalGeneral(){
    ...
    <body style="font-size: 8pt;>">
        ...
        <input type="hidden" id="pedidoval" value="">
            ...
            <!-- <b>SERIE: -</b> -->
            <br>
            <b><span style="font-size: 18pt;">NOTA DE CRÉDITO: <label id='idpedido'></label></span></b>
            <br>
            <br>
            <span style="font-size: 9.5pt;">DOCUMENTO DE REFERENCIA: <b><?php echo $_REQUEST["DocRef"];?></b></span>
            <br>
            <br>
            FECHA: <label id='fecha'></label>
            <br>
            VENDEDOR(A): <label id='Cajero'><?php echo $_SESSION['Nombres'];?></label>
            <br>
            <br>
