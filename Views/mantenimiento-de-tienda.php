		...
		<div class="container" style="margin: 160px auto 0px; max-width: 90%;font-family: Nunito;">
			...
			<div class="row">
				<div class="col-lg-12 text-right">
					<h4>MÓDULO DE CONFIGURACIONES <span class="glyphicon glyphicon-triangle-right" style="font-size: 13pt;"></span> MANTENIMIENTO DE TIENDA</h4>
					<hr>
				</div>	
				...
				<div class="col-lg-10" style="margin: 70px auto 0px; max-width: 100%;">
					...
					<!-- Inicio de formulario -->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">					
					    		<label for="exampleInputName2">NOMBRE DE TIENDA:</label>		
						...
						<div class="col-md-9">
                                                        <button type="submit" class="btn btn-default" style="height: 50px;">LIMPIAR TIENDA</button>
							<button type="submit" class="btn btn-success" style="height: 50px;">REGISTRAR TIENDA</button>
							<button type="submit" class="btn btn-warning" style="height: 50px;">MODIFICAR TIENDA</button>
							<button type="submit" class="btn btn-danger" style="height: 50px;">ELIMINAR TIENDA</button>	
						</div>						
					</div>	
