		...
		<div class="container" style="margin: 160px auto 0px; max-width: 90%;font-family: Nunito;">
			...
			<div class="row">
				<div class="col-lg-12 text-right"> 
					<h4>MÓDULO DE ALMACEN <span class="glyphicon glyphicon-triangle-right" style="font-size: 13pt;"></span>TRASLADOS INTERNOS</h4>
					<hr>
				</div>	
                            ...
                            <br>
                                        ...
                                        <div class="form-group">
                                            <table id="tablapedido" class="table table-striped">
                                                 <tr><td width="10">ID</td><td style="width: 350px;">PRODUCTO</td><td width="10">STOCK</td><td style="width: 150px;">MOVIMIENTO</td><td style="width: 50px;">FECHA MOV.</td></tr>
<!--                                                
